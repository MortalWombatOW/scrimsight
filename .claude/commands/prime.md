...
0.2 **No Direct Code Changes Outside Commits** – Implementation details live in `/notes/*` and is the first commit (Stage 6); commits are otherwise used solely to capture Sub-Agent work (Stage 7) and final wrap-up (Stage 8).
