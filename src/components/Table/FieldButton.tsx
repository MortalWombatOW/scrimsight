...
// import { RecordPredicate, Record, StrIndexable } from '../types';
...
//   const { fieldName, data, addPredicate } = props;
//   const [anchorEl, setAnchorEl] = useState<HTMLButtonElement | null>(null);
//   const open = Boolean(anchorEl);
//   const id = open ? 'simple-popover' : undefined;

//   const makeRangePredicate = (selection: number[]) => {
...
//     return { name: `${fieldName}: ${selection.join('->')}`, eval: evalFn };
//   };

//   const makeCategoricalPredicate = (selection: string[]) => {
//     const evalFn = (record: Record) => selection.includes(record[fieldName]);
//     console.log(selection); // eslint-disable-line no-console
//     return { name: `${fieldName}: ${selection.join(',')}`, eval: evalFn };
//   };
...
// variant="contained" onClick={(e) => setAnchorEl(e.currentTarget)}>
//         {fieldName}
//       </Button>
//       <Popover
//         id={id}
...
//             <Histogram
//               data={values}
//               onSelectionChange={(min, max) => addPredicate(makeRangePredicate([min, max]))}
//               width={600}
//               height={200}
//               bins={200}
//             />
...
// lected) => addPredicate(makeCategoricalPredicate(selected))}
//               />
//             )}
//         </div>
//       </Popover>
...
//   fieldName: string;
//   addPredicate: (f: RecordPredicate) => void;
//   data: Array<Record>;
// }
