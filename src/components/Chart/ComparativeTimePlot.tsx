...
// // accessors
// const date = (d: object) => d['Match Time'];
// const damageOne = (d: object) => Number(d['New York']);
// const sf = (d: object) => Number(d['San Francisco']);
...
// export default function ComparativeTimePlot({ width, height, margin = defaultMargin }: ThresholdProps) {
