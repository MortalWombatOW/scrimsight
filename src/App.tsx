...
const App = () => {
  ...
  const oidcConfig: AuthProviderProps = {
    authority: "https://discord.com/oauth2/authorize?client_id=815622008402477116&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fcallback&scope=identify+email",
    metadata: {
  ...
  const mtheme = createTheme({
    ...
    colors: {
      ...
      dark: ['#8c8c8c', '#6c6c6c', '#4c4c4c', '#2c2c2c', '#0c0c0c', '#0a0a0a', '#080808', '#060606', '#040404', '#020202'],
    },
