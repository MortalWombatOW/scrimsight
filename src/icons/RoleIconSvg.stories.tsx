...
export const AllRoles: Story = {
  render: () => (
    <svg width="300" height="100" style={{ background: "#2c2c2c" }}>
      ...
      <text x="150" y="90" textAnchor="middle" fill="white" fontSize="14">
        Damage
      </text>
      <text x="250" y="90" textAnchor="middle" fill="white" fontSize="14">
        Support
      </text>
    </svg>
  ),
...
export const Positions: Story = {
  render: () => (
    <svg width="200" height="200" style={{ background: "#2c2c2c" }}>
      ...
      <text x="150" y="30" textAnchor="middle" fill="white" fontSize="12">
        (150,50)
      </text>
      <text x="50" y="180" textAnchor="middle" fill="white" fontSize="12">
        (50,150)
      </text>
      <text x="150" y="180" textAnchor="middle" fill="white" fontSize="12">
        (150,150)
      </text>
    </svg>
  ),
...
export const WithGrid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows icon positioning with a reference grid. The grid is in 10px increments with highlighted center lines.",
      },
    },
  },
};
