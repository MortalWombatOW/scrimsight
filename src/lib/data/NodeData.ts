...
export const NODES: DataNode<any>[] = [
  new ObjectStoreNode<any>('maps_object_store', 'maps'),
  new ObjectStoreNode<any>('match_start_object_store', 'match_start'),
  new ObjectStoreNode<any>('match_end_object_store', 'match_end'),
  new ObjectStoreNode<any>('round_start_object_store', 'round_start'),
  new ObjectStoreNode<any>('round_end_object_store', 'round_end'),
  new ObjectStoreNode<any>('setup_complete_object_store', 'setup_complete'),
  new ObjectStoreNode<any>(
    'objective_captured_object_store',
    'objective_captured',
  ),
  new ObjectStoreNode<any>('point_progress_object_store', 'point_progress'),
  new ObjectStoreNode<any>('payload_progress_object_store', 'payload_progress'),
  new ObjectStoreNode<any>('hero_spawn_object_store', 'hero_spawn'),
  new ObjectStoreNode<HeroSwap>('hero_swap_object_store', 'hero_swap'),
  ...
  new ObjectStoreNode<UltimateEnd>('ultimate_end_object_store', 'ultimate_end'),
  new ObjectStoreNode<Kill>('kill_object_store', 'kill'),
  new ObjectStoreNode<Damage>('damage_object_store', 'damage'),
  new ObjectStoreNode<Healing>('healing_object_store', 'healing'),
  new ObjectStoreNode<MercyRez>('mercy_rez_object_store', 'mercy_rez'),
  ...
  new ObjectStoreNode<DvaDemech>('dva_demech_object_store', 'dva_demech'),
  new ObjectStoreNode<DvaRemech>('dva_remech_object_store', 'dva_remech'),
  new ObjectStoreNode<RemechCharged>(
    'remech_charged_object_store',
    'remech_charged',
  ),
  new ObjectStoreNode<any>('player_stat_object_store', 'player_stat'),
  new WriteNode<any>('maps_write_node', 'maps', []),
  new WriteNode<any>('match_start_write_node', 'match_start', []),
  new WriteNode<any>('match_end_write_node', 'match_end', []),
  new WriteNode<any>('round_start_write_node', 'round_start', []),
  new WriteNode<any>('round_end_write_node', 'round_end', []),
  new WriteNode<any>('setup_complete_write_node', 'setup_complete', []),
  new WriteNode<any>('objective_captured_write_node', 'objective_captured', []),
  new WriteNode<any>('point_progress_write_node', 'point_progress', []),
  new WriteNode<any>('payload_progress_write_node', 'payload_progress', []),
  new WriteNode<any>('hero_spawn_write_node', 'hero_spawn', []),
  new WriteNode<any>('hero_swap_write_node', 'hero_swap', []),
  new WriteNode<any>('ability_1_used_write_node', 'ability_1_used', []),
  new WriteNode<any>('ability_2_used_write_node', 'ability_2_used', []),
  new WriteNode<any>('offensive_assist_write_node', 'offensive_assist', []),
  new WriteNode<any>('defensive_assist_write_node', 'defensive_assist', []),
  new WriteNode<any>('ultimate_charged_write_node', 'ultimate_charged', []),
  new WriteNode<any>('ultimate_start_write_node', 'ultimate_start', []),
  new WriteNode<any>('ultimate_end_write_node', 'ultimate_end', []),
  new WriteNode<any>('kill_write_node', 'kill', []),
  new WriteNode<any>('damage_write_node', 'damage', []),
  new WriteNode<any>('healing_write_node', 'healing', []),
  new WriteNode<any>('mercy_rez_write_node', 'mercy_rez', []),
  new WriteNode<any>(
    'echo_duplicate_start_write_node',
    'echo_duplicate_start',
    [],
  ),
  new WriteNode<any>('echo_duplicate_end_write_node', 'echo_duplicate_end', []),
  new WriteNode<any>('dva_demech_write_node', 'dva_demech', []),
  new WriteNode<any>('dva_remech_write_node', 'dva_remech', []),
  new WriteNode<any>('remech_charged_write_node', 'remech_charged', []),
  new WriteNode<any>('player_stat_write_node', 'player_stat', []),
